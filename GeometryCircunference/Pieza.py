...
class Pieza():
    ...
    def DrawCircle(self):
        if(self._seed == 0):
            # pygame.draw.arc(self._surface, (255,0,0), 
            #                 (-self._radius + self._cirThick/2,-self._radius + self._cirThick/2,self._diameter ,self._diameter ),
            #                 math.pi*3/2,0,self._cirThick)

            # pygame.draw.arc(self._surface, (0,255,0),
            #                 (self._radius - self._cirThick/2, self._radius - self._cirThick/2,self._diameter ,self._diameter ),
            #                 math.pi/2,math.pi,self._cirThick)

            pygame.draw.circle(self._surface, (0,255,0),(self._cirThick/2, self._cirThick/2), self._radius, self._cirThick)
            ...
            # pygame.draw.arc(self._surface, (0,0,255),
            #                 (-self._radius + self._cirThick/2,self._radius - self._cirThick/2,self._diameter,self._diameter),
            #                 0,math.pi/2,self._cirThick)

            # pygame.draw.arc(self._surface, (0,0,0),
            #                 (self._radius - self._cirThick/2,-self._radius,self._diameter ,self._diameter),
            #                 math.pi,math.pi*3/2,self._cirThick)
            pygame.draw.circle(self._surface, (0,0,255),(self._cirThick/2, self._diameter - self._cirThick/2), self._radius, self._cirThick)
            pygame.draw.circle(self._surface, (0,0,0),(self._diameter - self._cirThick/2 , self._cirThick/2), self._radius, self._cirThick)
